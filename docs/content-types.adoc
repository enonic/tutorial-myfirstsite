...
As can be seen, Columbia, Norway, USA and Templates are all child content of the root hello-world content (ignore "Templates" for now, you'll get to know about it later). Select the hello-world content and click on edit.
