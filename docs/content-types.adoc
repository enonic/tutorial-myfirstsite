...
TIP: Visit these links for more information about https://developer.enonic.com/docs/xp/stable/cms/content-types[standard content types] and about https://developer.enonic.com/docs/xp/stable/cms/schemas[custom content types]
