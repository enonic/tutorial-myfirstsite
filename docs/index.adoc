...
+
video::images/hello-world.mp4["Animation showing process of setting up page" options=autoplay]
...
[source,js]
----
include::code/pages/hello-template/hello.js[]
----
+
...
[source,html]
----
include::code/pages/hello-template/hello.html[]
----
+
. Redeploy the app:
+
...
[source,js]
----
include::code/pages/hello-region/hello-region.js[]
----
+
.hello-region.html:
[source,HTML]
----
include::code/pages/hello-region/hello-region.html[]
----
+
...
[source,XML]
----
include::code/pages/hello-region/hello-region.xml[]
----
+
...
+
video::images/hello-regions.mp4[options=autoplay]
...
[source,Javascript]
----
include::code/parts/country/country.js[]
----
+
.country.html
[source,HTML]
----
include::code/parts/country/country.html[]
----
+
...
[source,XML]
----
include::code/parts/city-list/city-list.xml[]
----
+
...
[source,Javascript]
----
include::code/parts/city-list/city-list.js[]
----
+
...
[source,HTML]
----
include::code/parts/city-list/city-list.html[]
----
+
