...
[source,js]
----
include::{source_dir}code-samples/parts/country/country.js[]
----
+
.src/main/resources/site/parts/country/country.html
[source,HTML]
----
include::{source_dir}code-samples/parts/country/country.html[]
----
+
...
[source,js]
----
include::{source_dir}code-samples/parts/city-list/city-list.js[]
----
+
.src/main/resources/site/parts/city-list/city-list.html
[source,HTML]
----
include::{source_dir}code-samples/parts/city-list/city-list.html[]
----
+
...
[source,XML]
----
include::{source_dir}code-samples/parts/city-list/city-list.xml[]
----
+
