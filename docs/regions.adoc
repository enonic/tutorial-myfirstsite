...
You now have a page with a region! 
...
You've been introduced to regions, a concept that can be used on a page, as you just saw, but also on layouts, a new concept you'll be introduced later on.

Next you'll learn about part, which are highly customizable components that can be inserted into regions.